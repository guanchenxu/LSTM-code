...
y_true = np.load(y_test_path)  # 标准化后的测试集标签
...
def run_experiments(feature_modes=FEATURE_MODES, pred_modes=PRED_MODES):
    ...
    for feature_mode in feature_modes:
        for pred_mode in pred_modes:
            ...
            metrics_overall = compute_metrics(y_true_raw, y_pred_test)
            metrics_step = compute_step_metrics(y_true_raw, y_pred_test)
